...
function __.may_create_dir(dir)
...
function __.rand_element(seq)
  local idx = __.rand_int(1, #seq)
...
--- @return boolean
function __.is_compatible_version(expected_version)
